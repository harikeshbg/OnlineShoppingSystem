/*
OPEN ENDED PROJECT ON C++.
TOPIC:      ONLINE SHOPPING SYSTEM
MEMBER 1:   ARUN P N
            (USN-1SI17IS007)
MEMBER 2:   HARIKESH B G
            (USN-1SI17IS012)
*/
...
void cardpay()
{
    ...
    cout<<"\t\t\t\t\t\t\t\tYour product will be delivered within 10 days by our agent ARUN P.N. +91-8660397320."<<endl;
    delay(5000);
}
void cashpay()
{
    ...
    cout<<"\t\t\t\t\t\t\t\tYour product will be delivered within 10 days by our agent HARIKESH B.G. +91-9380351145."<<endl;
    delay(5000);
}
void fetchdata()
{
           ...
           void readpurchase()
           {
               ...
               //system("COLOR 40");
                    ...
                    do
                    {
                        ...
                        cin.ignore();
                        p.idindex++;
                        cout<<endl<<endl<<"\t\t\t\t\t\tDo you want to continue shopping:....(y/n)?";
                        cin>>idchoice;
                    ...
                    system("cls");
                    cout<<"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\t\t  Do you want to view your purchase history...(y/n):";
                    char phistory;
                    cin>>phistory;
                    system("cls");
                    if(phistory=='y'||phistory=='Y')
                    {
                        cout<<endl<<endl<<"\t\t\t\t\t\t\t\tPURCHASE HISTORY:"<<endl;
                        viewhistory(p);
                    }
                    delay(15000);
           }
